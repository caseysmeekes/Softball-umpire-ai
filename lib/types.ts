...
export type Violation = { umpireId:string; rule:'MAX_GAMES'|'BACK_TO_BACK'|'PLATE_BREAK'|'PLATE_BALANCE'|'NO_DOUBLE_BOOKING'|'ONE_PLATE'|'SAME_GAME_MULTIPLE_POSITIONS'; severity:'hard'|'soft'; message:string; gameId?:string }
